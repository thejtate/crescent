(function ($) {
  ...
  function initTabslogo() {
    ...
    var $list = $wrapper.find('.view-fblog-category'),
      $nav = $list.find('.views-summary');

    $list.prepend('<span class="title-nav">' + $list.find('.views-summary a.active').html() + '</span>');
    var $title = $wrapper.find('.title-nav');
  ...
  function initContactTabs() {
    ...
    function hideCites(el) {
      el.parents('.control-wrapper').siblings('.view-contact').find('.views-row').removeClass('active');
    ...
    function showAllLocations(el) {
      ...
      el.parents('.control-wrapper').siblings('.view-contact').find('.views-row').addClass('active');
